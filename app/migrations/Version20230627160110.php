 ...
 */
final class Version20230627160110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE guest_user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(191) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE url_data (id INT AUTO_INCREMENT NOT NULL, url_id INT NOT NULL, visit_time DATETIME NOT NULL, INDEX IDX_B3A73ADB81CFDAE7 (url_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE urls (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, guest_user_id INT DEFAULT NULL, short_name VARCHAR(191) NOT NULL, long_name VARCHAR(255) NOT NULL, create_time DATETIME NOT NULL, is_blocked TINYINT(1) NOT NULL, block_time DATETIME DEFAULT NULL, INDEX IDX_2A9437A1A76ED395 (user_id), INDEX IDX_2A9437A1E7AB17D9 (guest_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE urls ADD CONSTRAINT FK_2A9437A1E7AB17D9 FOREIGN KEY (guest_user_id) REFERENCES guest_user (id)');
